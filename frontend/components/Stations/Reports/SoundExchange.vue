        ...
        >
            <div class="card-body">
                <form-fieldset>
                    ...
                    <ul>
                        <li>
                            Aplus assumes that your station fits SoundExchange Transmission Category A, "Eligible
                        ...
                        <li>
                            The data collected by Aplus meets the SoundExchange standard for Actual Total
                        ...
                        <li>
                            Reporting requirements for SoundExchange may change at any time. Aplus is non-commercial
                            community-built software and cannot guarantee that its reporting format will always be
                            up-to-date.
                        </li>
                        <li>
                            You should always verify the report generated by Aplus before sending it. In particular,
                ...
                <form-fieldset class="row">
                    ...
                    >
                        ...
                        <template #description>
                            {{
                                $gettext('If enabled, Aplus will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.')
                            }}
                        </template>
                    </form-group-checkbox>
                </form-fieldset>
