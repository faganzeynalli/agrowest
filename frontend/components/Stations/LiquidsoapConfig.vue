    ...
    >
        ...
        >
            ...
            <info-card>
                ...
                <p class="card-text">
                    {{
                        $gettext('The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Aplus.')
                    }}
                </p>
                <p class="card-text">
                    {{
                        $gettext('This is an advanced feature and custom code is not officially supported by Aplus. You may break your station by adding custom code, but removing it should fix any issues.')
                    }}
                </p>
            </info-card>
