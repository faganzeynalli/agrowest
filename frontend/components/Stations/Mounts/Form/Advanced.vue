    ...
    >
        <div class="row g-3 mb-3">
            <form-group-field
                ...
                :description="$gettext('You can set a custom URL for this stream that Aplus will use when referring to it on the web interface and in the Now Playing API return data. Leave empty to use the default value.')"
            />
        </div>
        <div
            v-if="isIcecast"
