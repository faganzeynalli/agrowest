        ...
        >
            <form-group id="import_modal_playlist_file">
                ...
                <template #description>
                    {{
                        $gettext('Aplus will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.')
                    }}
                </template>
