        ...
        <form-fieldset>
            ...
            <div class="row g-3">
                ...
                >
                    <template #description>
                        <a
                            ...
                            target="_blank"
                        >
                            {{ $gettext('Learn more about release channels in the Aplus docs.') }}
                        </a>
                    </template>
                ...
                <form-group-checkbox
                    ...
                    :description="$gettext('Show new releases within your update channel on the Aplus homepage.')"
                />
            </div>
        </form-fieldset>
        ...
        <form-fieldset>
            ...
            <div class="row g-3">
                <form-group-field
                    ...
                    :description="$gettext('All listed domain names should point to this Aplus installation. Separate multiple domain names with commas.')"
                />
