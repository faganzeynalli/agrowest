            ...
            <form-fieldset v-if="enableAdvancedFeatures">
                ...
                <div class="row g-3">
                    ...
                    >
                        <template #description>
                            {{
                                $gettext('This mode disables Aplus\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.')
                            }}
                        </template>
                    </form-group-checkbox>
...
import {AudioProcessingMethods, BackendAdapters} from "~/entities/RadioAdapters";
