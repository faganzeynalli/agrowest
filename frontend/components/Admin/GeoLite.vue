                ...
                <div class="row g-3">
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <p class="card-text">
                                {{
                                    $gettext('Aplus ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.')
                                }}
                            </p>
                            <p class="card-text">
