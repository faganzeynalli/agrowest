                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <form-group-checkbox
                                ...
                                :label="$gettext('Hide Aplus Branding on Public Pages')"
                                :description="$gettext('If selected, this will remove the Aplus branding from public-facing pages.')"
                            />
                        </div>
                        ...
                        <form-group-field
                            ...
                            :description="$gettext('If a visitor is not signed in and visits the Aplus homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.')"
                        />
