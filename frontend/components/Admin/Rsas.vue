                ...
                <div class="row g-3">
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <p class="card-text">
                                {{
                                    $gettext('Rocket Streaming Audio Server (RSAS) is a closed-source alternative to Icecast as a broadcasting frontend. As it is proprietary, Aplus cannot distribute it, but you can install it via this page. If installed, stations can select it as their broadcasting software.')
                                }}
                            </p>
