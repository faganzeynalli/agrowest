<?php return array (
  ...
  array (
    ...
    array (
      ...
      'A unique identifier (i.e. "G-A1B2C3D4") for this measurement stream.' => 'Bu ölçüm akışı için benzersiz bir tanımlayıcı (Örnek: "G-A1B2C3D4").',
      ...
      'An error occurred while loading the station profile:' => 'Radyo profili yüklenirken bir hata oluştu:',
      'An error occurred with the WebDJ socket.' => 'WebDJ bağlantısında bir hata oluştu.',
      ...
      'If your Mastodon username is "@test@example.com", enter "example.com".' => 'Mastodon kullanıcı adınız "@test@example.com" ise "example.com" yazın.',
      ...
      'Now playing on %{ station }:' => '%{ station } çalan şarkı:',
      'Now playing on %{ station }: %{ title } by %{ artist }! Tune in now: %{ url }' => '%{ station } çalan şarkı: %{ artist } - %{ title }! Şimdi dinle: %{ url }',
      'Now playing on %{ station }: %{ title } by %{ artist }! Tune in now.' => '%{ station } çalan şarkı: %{ artist } - %{ title }! Şimdi dinle.',
      ...
      'Stereo Tool version %{ version } is currently installed.' => 'Stereo Aracı %{ version } sürümü şu anda yüklü.',
      'Stop' => 'Durdur',
      ...
      'WebDJ' => 'WebDJ',
      'WebDJ connected!' => 'WebDJ bağlandı!',
